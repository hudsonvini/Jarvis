			...
			<div className={styles.gridCardsArea}>
				<article className={`${styles.card} ${styles.cardPrincipal}`}>
                    <div className={styles.areaText}>
                        ...
                        <p className={styles.descriptionCard}>Este curso nasce alinhado às transformações globais que estão redefinindo o mercado. Hoje, o mundo precisa de jovens capazes de pensar de forma crítica, resolver problemas reais e usar a tecnologia para criar soluções com impacto.</p>
                        <div className={styles.professorArea}>
                            <div className={styles.image}>
                                <img src="https://images.pexels.com/photos/1062280/pexels-photo-1062280.jpeg" alt="" />
                            </div>
                    ...
                    <img className={styles.imagePrincipal} src="/images/professor-robotica.png" alt="Professor Robotica" />
                    <div className={styles.tagHour}>72h</div>
                    <a className={styles.buttonInscrever} href="/sobre">Inscrever-se<ArrowRight /></a>
				</article>
				...
				<article className={`${styles.card} ${styles.cardSecondary1}`}>
                    ...
                    <img className={styles.imagePrincipal} src="/images/image-front.png" alt="Professor Robotica" />
                    <div className={styles.tagHour}>72h</div>
                    <a className={styles.buttonInscrever} href="">Inscrever-se<ArrowRight /></a>
				</article>
				...
				<article className={`${styles.card} ${styles.cardSecondary2}`}>
                    ...
                    <img className={styles.imagePrincipal} src="/images/image-motion-curso.png" alt="Professor Robotica" />
                    <div className={styles.tagHour}>72h</div>
                    <a className={styles.buttonInscrever} href="/sobre">Inscrever-se<ArrowRight /></a>
				</article>
				...
				<article className={`${styles.card} ${styles.cardBanner}`}>
                    <div className={styles.areaText}>
                        <div className={styles.topArea}>
                            <span className={styles.tag}>APRENDA A JOGAR O SEU JOGO FAVORITO</span>
                            <img className={styles.titleAtleta} src="/images/text-atleta-digital.svg" alt="" />
                        </div>
                    ...
                    <img className={styles.imagePrincipal} src="/images/curso-atleta.png" alt="Professor Robotica" />
                    <div className={styles.tagHour}>72h</div>
				</article>
