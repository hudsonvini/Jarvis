...
export default function FaqSection() {
	...
	useEffect(() => {
		const ctx = gsap.context(() => {
			...
			if (!section || !giantWord) return;

			const svgElement = giantWord.querySelector("svg");
			const svgDrawTargets = svgElement?.querySelectorAll(
			...
			if (svgDrawTargets?.length) {
				svgDrawTargets.forEach((el) => {
					try {
